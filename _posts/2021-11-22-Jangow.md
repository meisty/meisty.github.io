...
I took a look at [Exploitdb CVE-2017-16995](https://www.exploit-db.com/exploits/45010), I created the exploit locally and transferred it across to the victim machine.  After compiling it with ```gcc 45010.c -o harmless``` and making sure it had executable privileges I ran the exploit.
